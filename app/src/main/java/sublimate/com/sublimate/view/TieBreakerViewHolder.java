...
public class TieBreakerViewHolder extends RecyclerView.ViewHolder {
    ...
    public TieBreakerViewHolder(@NonNull View itemView, Context context, List<InventoryItem> inventoryItems) {
        super(itemView);
